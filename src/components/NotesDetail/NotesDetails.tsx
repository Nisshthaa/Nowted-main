...
const NotesDetails: React.FC = () => {
  const { selectedNoteId, selectedFolder } = useApp();
  ...
  return (
    // notes-details
    <div className="w-250 h-screen p-12.5  flex flex-col ">
    <div className="flex flex-col border border-amber-400">
        {/* title */}
      <div className="flex justify-between ">
        ...
        <div>
          <CircleEllipsis className="text-(--text-secondary) w-7.5 h-7.5 rounded-[100px] absolute" />
          <div className="flex flex-col w-53.5 h-37.5 bg-[#333333] p-3.75 justify-between gap-5 rounded-md relative top-15.5">
